			...
			<div class="container">
				...
				<p class="copyright"><span class="copyright-date">
					...
					?>
					  ...
					  <?php printf(__('&#8226; Designed by', 'emmet-lite')); ?> <a href="<?php echo esc_url(__('https://www.aaronthomas.ml/', 'emmet-lite' )); ?>" rel="nofollow" title="<?php esc_attr_e('Premium WordPress Plugins and Themes', 'emmet-lite' ); ?>"><?php _e('Aaron Thomas', 'emmet-lite'); ?></a>
					  <?php printf(__('&#8226; Proudly Powered by ',  'emmet-lite')); ?><a href="<?php echo esc_url(__('https://www.biblestudy.cf/', 'emmet-lite')); ?>"  rel="nofollow" title="<?php esc_attr_e('Semantic Personal Publishing Platform', 'emmet-lite' ); ?>"><?php _e('BIBLE STUDY',  'emmet-lite' ); ?></a>
					  <?php
					?>
				</p><!-- .copyright -->
			</div>
