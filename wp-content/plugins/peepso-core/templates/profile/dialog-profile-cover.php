...
<div id="dialog-upload-cover">
	<div id="dialog-upload-cover-title" class="hidden"><?php echo __('Change Cover Photo', 'peepso-core'); ?></div>
	<div id="dialog-upload-cover-content">
		...
		<ul class="ps-list <?php if ($PeepSoUser->has_cover()) { echo 'ps-list-half'; } ?> upload-cover">
			...
			<li class="ps-list-item">
				<a href="#" onclick="profile.remove_cover_photo(<?php echo $PeepSoUser->get_id(); ?>); return false;" class="ps-btn ps-btn-danger ps-full"><?php echo __('Remove Cover Photo', 'peepso-core'); ?></a>
			</li>
			<?php } ?>
...
<div style="display: none;">
	<div id="profile-cover-error-filetype"><?php echo __('The file type you uploaded is not allowed. Only JPEG/PNG allowed.', 'peepso-core'); ?></div>
