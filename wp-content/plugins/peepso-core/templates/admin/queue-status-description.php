...
<div style="opacity: 0.7;font-size:10px;">
    <p>
        <?php echo __('PeepSo uses various scheduled tasks (cron jobs) in order to perform background actions such as: sending e-mails, generating GDPR exports, performing routine database maintenance etc.','peepso-core'); ?>
        <br/>
