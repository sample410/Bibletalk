<div class="ps-location-wrapper ps-js-location-wrapper" style="display:block">
	<div class="ps-location ps-js-location ps-clearfix" style="position:relative;border:0 none">
		<input type="text" class="ps-input ps-input-full" placeholder="<?php echo __('Enter location name...', 'peepso-core'); ?>" />
		...
		<div class="ps-location-result ps-js-location-result">
			...
			<a href="#" class="ps-btn ps-btn-small ps-btn-primary ps-js-select" style="top:42px"><?php echo __('Select', 'peepso-core'); ?></a>
			<a href="#" class="ps-btn ps-btn-small ps-btn-danger ps-js-remove" style="top:42px"><?php echo __('Remove', 'peepso-core'); ?></a>
		</div>
	</div>
