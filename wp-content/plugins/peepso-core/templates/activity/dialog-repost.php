...
<div id="repost-dialog">
	...
	<div class="dialog-content">
		<div class="ps-postbox-input ps-inputbox">
			<textarea id="share-post-box" class="ps-textarea" placeholder="<?php echo __('Say what is on your mind...', 'peepso-core'); ?>"></textarea>
		</div>
	...
	<div class="dialog-action">
		...
		<button type="button" name="rep_submit" class="ps-btn ps-btn-small ps-button-action" onclick="activity.submit_repost(); return false;"><?php echo __('Share', 'peepso-core'); ?></button>
	</div>
</div>
