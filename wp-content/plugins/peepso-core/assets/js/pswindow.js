...
PsWindow.prototype.confirm_delete = function(deleteCallback, content) {
	...
	var actions = [
		'<button type="button" class="ps-btn ps-btn-small ps-button-cancel" onclick="pswindow.hide(); return false;">',
		data.label_cancel,
		'</button>',
		'<button type="button" class="ps-btn ps-btn-small ps-button-action" onclick="pswindow.do_delete();">',
		data.label_delete,
		'</button>'
	].join(' ');
...
PsWindow.prototype.acknowledge = function(message, title) {
	...
	var data = peepsowindowdata || {};
	var actions = [
		'<button type="button" class="ps-btn ps-btn-small ps-button-action" onclick="pswindow.hide(); return false;">',
		data.label_okay,
		'</button>'
	].join(' ');
...
PsWindow.prototype.confirm = function(message, callback, no_confirm_callback) {
	...
	var actions = [
		...
		'</button>',
		'<button type="button" class="ps-btn ps-btn-small ps-button-action" onclick="return pswindow.do_confirm();">',
