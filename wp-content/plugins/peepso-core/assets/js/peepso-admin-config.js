	...
	$(document).ready(function() {
		...
		$('input[name=site_reporting_enable]')
			.on(
				'click',
				_.throttle(function() {
					var $unpublish = $('input[name=site_reporting_num_unpublish_post]'),
						$reason = $('textarea[name=site_reporting_types]'),
			...
			$recaptcha_enable
				.on('change', function() {
					if ($(this).is(':checked')) {
						...
						$('#field_site_registration_recaptcha_use_globally').fadeIn(hide_animation_speed);
					} else {
						...
						$('#field_site_registration_recaptcha_use_globally').fadeOut(hide_animation_speed);
					}
				})
				.trigger('change');
		}
